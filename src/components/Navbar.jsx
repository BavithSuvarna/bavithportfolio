...
const Navbar = () => {
  ...
  <div className="flex items-center justify-between max-w-screen-xl mx-auto">
    ...
    <div className="hidden md:flex m-8 items-center justify-center gap-6 text-2xl text-white font-medium">
      <a href="#journey" className="hover:text-purple-400 transition font-thin text-white">Journey</a>
      <a href="#projects" className="hover:text-purple-400 transition font-thin text-white">Projects</a>
      <a href="#technologies" className="hover:text-purple-400 transition font-thin text-white">Experience</a>
